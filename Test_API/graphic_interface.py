from tkinter import *
from api_test import nuage_pourcent, vue_distance ,temp_fahrenheit, temp_celsius,feels_like_fahrenheit, feels_like_celsius, city, humidity, sunset_time, sunrise_time, weather1, wind_speed, humidity, description
...
nuage_densite = Label(mainf,text=f"Le taux d'humiditée: {humidity} %", font=("arial", 15), fg="black",bg="orange")
